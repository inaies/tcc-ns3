...
main(int argc, char* argv[])
{
    ...
    Simulator::Schedule(Seconds(35.0), &Ipv6::SetUp, ipv6, ifIndex);
    // Simulator::Schedule(Seconds(40.0), &RipNg::DoInitialize, &ripNg);
