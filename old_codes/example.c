pv6StaticRoutingHelper routingHelper;
...
// Sub-rede p2p entre AP2 e AP3
staticRoutingAp1->AddNetworkRouteTo(Ipv6Address("fd00:0:0:1::"), Ipv6Prefix(64), p2pIfs1.GetAddress(0,0), 2);
staticRoutingAp1->AddNetworkRouteTo(Ipv6Address("fd00:0:0:2::"), Ipv6Prefix(64), p2pIfs3.GetAddress(0,0), 3);
...
// Rede do AP3
staticRoutingAp2->AddNetworkRouteTo(Ipv6Address("2001:db8:2::"), Ipv6Prefix(64), p2pIfs2.GetAddress(0,0), 3);
// Sub-redes p2p
staticRoutingAp2->AddNetworkRouteTo(Ipv6Address("fd00:0:0:0::"), Ipv6Prefix(64), p2pIfs1.GetAddress(1,0), 2);
staticRoutingAp2->AddNetworkRouteTo(Ipv6Address("fd00:0:0:2::"), Ipv6Prefix(64), p2pIfs2.GetAddress(0,0), 3);
...
// Sub-redes p2p
staticRoutingAp3->AddNetworkRouteTo(Ipv6Address("fd00:0:0:0::"), Ipv6Prefix(64), p2pIfs3.GetAddress(1,0), 3);
staticRoutingAp3->AddNetworkRouteTo(Ipv6Address("fd00:0:0:1::"), Ipv6Prefix(64), p2pIfs2.GetAddress(1,0), 2);
